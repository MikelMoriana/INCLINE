# Loading libraries and getting files from OSF----
...
#Community data until 2022, which was double-checked
get_file(node = "zhk3m",
...
#Community data
community_wrong<- read_delim("data\\INCLINE_community_2018_2019_2021_2022_2023.csv", col_types = cols(.default = col_character()))
community_data_2023 <- community_wrong |> filter(year == 2023)
community_data_korrekturlest <- read_delim("data\\INCLINE_community_2018_2019_2021_2022_korrekturlest.csv", col_types = cols(.default = col_character()))

# We need to correct a few mistakes from the korrekturlest data before merging them
community_data_4years <- community_data_korrekturlest |> 
  mutate(...226 = ifelse(Site == "Ulvehaugen" & year == 2018 & Block == 4 & plot == 3 & subPlot == 10, NA, ...226)) |> 
  mutate(Veg_height_mm = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 10, 75, Veg_height_mm),
         Moss_depth_mm = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 10, 7, Moss_depth_mm),
         ...226 = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 10, NA, ...226)) |> 
  mutate(Veg_height_mm = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 12, 106, Veg_height_mm),
         Moss_depth_mm = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 12, 12, Moss_depth_mm),
         ...226 = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 12, NA, ...226)) |> 
  mutate(Veg_height_mm = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 24, 90, Veg_height_mm),
         Moss_depth_mm = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 24, 6, Moss_depth_mm),
         ...226 = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 24, NA, ...226)) |> 
  mutate(Veg_height_mm = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 26, 87, Veg_height_mm),
         Moss_depth_mm = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 26, 14, Moss_depth_mm),
         ...226 = ifelse(Site == "Gudmedalen" & year == 2018 & Block == 5 & plot == 6 & subPlot == 26, NA, ...226)) |> 
  mutate(...226 = ifelse(Site == "Ulvehaugen" & year == 2022 & Block == 1 & plot == 4 & subPlot == "cover", NA, ...226),
         comments = ifelse(Site == "Ulvehaugen" & year == 2022 & Block == 1 & plot == 4 & subPlot == "cover", "Satt car_sp på car_big: Spiss tupp, mørkefgrønne og kraftige blad.", comments)) |> 
  mutate(Moss_depth_mm = ifelse(Site == "Gudmedalen" & year == 2022 & Block == 2 & plot == 4 & subPlot == 12, 26, Moss_depth_mm),
         ...226 = ifelse(Site == "Gudmedalen" & year == 2022 & Block == 2 & plot == 4 & subPlot == 12, NA, ...226)) |> 
  mutate(Moss_depth_mm = ifelse(Site == "Gudmedalen" & year == 2022 & Block == 2 & plot == 4 & subPlot == 24, 3, Moss_depth_mm),
         ...226 = ifelse(Site == "Gudmedalen" & year == 2022 & Block == 2 & plot == 4 & subPlot == 24, NA, ...226)) |> 
  mutate(Moss_depth_mm = ifelse(Site == "Gudmedalen" & year == 2022 & Block == 2 & plot == 4 & subPlot == 26, 3, Moss_depth_mm),
         ...226 = ifelse(Site == "Gudmedalen" & year == 2022 & Block == 2 & plot == 4 & subPlot == 26, NA, ...226)) |> 
  mutate(...226 = ifelse(Site == "Gudmedalen" & year == 2022 & Block == 3 & plot == 6 & subPlot == "cover", NA, ...226),
         comments = ifelse(Site == "Gudmedalen" & year == 2022 & Block == 3 & plot == 6 & subPlot == "cover", "Gal: 4 leaves, brodd spiss? Tydelig midtnerve", comments)) |> 
  select(!...226)


community_data_download <- bind_rows(community_data_4years, community_data_2023)
...
# Fixing general mistakes in the dataset----
...
community_data <- community_data_download |>
  ...
  mutate(vegetation_height_mm = ifelse(plotID == "Lav_4_6" & year == 2018 & subPlot == 10, 47, vegetation_height_mm)) |> 
  mutate(moss_depth_mm = ifelse(plotID == "Lav_4_6" & year == 2018 & subPlot == 10, 30, moss_depth_mm)) |>
  mutate(vegetation_height_mm = ifelse(plotID == "Lav_4_6" & year == 2018 & subPlot == 12, 53, vegetation_height_mm)) |>
  mutate(moss_depth_mm = ifelse(plotID == "Lav_4_6" & year == 2018 & subPlot == 12, 63, moss_depth_mm)) |>
  mutate(vegetation_height_mm = ifelse(plotID == "Lav_4_6" & year == 2018 & subPlot == 24, 44, vegetation_height_mm)) |>
  mutate(moss_depth_mm = ifelse(plotID == "Lav_4_6" & year == 2018 & subPlot == 24, 46, moss_depth_mm)) |>
  mutate(vegetation_height_mm = ifelse(plotID == "Lav_4_6" & year == 2018 & subPlot == 26, 38, vegetation_height_mm)) |>
  mutate(moss_depth_mm = ifelse(plotID == "Lav_4_6" & year == 2018 & subPlot == 26, 37, moss_depth_mm)) |>
  ...
  mutate(litter = ifelse(litter == "1+", 10, litter),
         litter = ifelse(litter == "1o", 10, litter),
         litter = as.numeric(litter, na.rm = TRUE))|>
  ...
  mutate(logger = ifelse(logger == "logger", 100, logger),
         logger = as.numeric(logger, na.rm = TRUE))|>
  mutate(vegetation_cover = ifelse(vegetation_cover == "83% L5%", 83, vegetation_cover),
         vegetation_cover = ifelse(vegetation_cover == "84% (L5%)", 84, vegetation_cover),
         vegetation_cover = ifelse(vegetation_cover == "85% (L5%)", 85, vegetation_cover),
         vegetation_cover = ifelse(vegetation_cover == "88% (5%L)", 88, vegetation_cover),
         vegetation_cover = ifelse(vegetation_cover == "91% (5%L)", 91, vegetation_cover),
         vegetation_cover = ifelse(vegetation_cover == "91% (L5%)", 91, vegetation_cover),
         vegetation_cover = ifelse(vegetation_cover == "92% (L 5%)", 92, vegetation_cover),
         vegetation_cover = ifelse(vegetation_cover == "92% (S%L)", 92, vegetation_cover),
         vegetation_cover = ifelse(vegetation_cover == "95% (L)", 95, vegetation_cover),
         vegetation_cover = ifelse(vegetation_cover == "95% (L5%)", 95, vegetation_cover),
         vegetation_cover = ifelse(vegetation_cover == "95% (S-L)", 95, vegetation_cover),
         vegetation_cover = as.numeric(vegetation_cover, na.rm = TRUE))|>
  mutate(vegetation_height_mm = as.numeric(vegetation_height_mm, na.rm = TRUE))|>
  mutate(moss_depth_mm = ifelse(moss_depth_mm == "no bryo", NA, moss_depth_mm),
         moss_depth_mm = as.numeric(moss_depth_mm, na.rm = TRUE))|>
...
Skj_1_1_Agr_mer_2019_fix <- community_clean |> 
  ...
  mutate(year = 2019,
         ...
         moss = ifelse(subPlot == 2, 30, 
                       ifelse(subPlot == 7, 25, 
                              ifelse(subPlot == 8, 45, 
                                     ifelse(subPlot == 12, 40, 
                                            ifelse(subPlot == 20, 30, 
                                                   ifelse(subPlot == 26, 15, NA)))))),
         lichen = ifelse(subPlot == 20, 3, NA),
         litter = ifelse(subPlot == 2, 15, 
                         ifelse(subPlot == 7, 8, 
                                ifelse(subPlot == 8, 5, 
                                       ifelse(subPlot == 12, 5, 
                                              ifelse(subPlot == 20, 4, 
         ...
         poo = NA,
         fungus = NA,
         bare = ifelse(subPlot == 7, 5, 
                              ifelse(subPlot == 8, 3, 
                                     ifelse(subPlot == 12, 3, 
                                            ifelse(subPlot == 20, 2, 
                                                   ifelse(subPlot == 26, 15, NA))))),
         logger = NA,
         vegetation_height_mm = ifelse(subPlot == 12, 57, 
                                       ifelse(subPlot == 26, 26, NA)),
         moss_depth_mm = ifelse(subPlot == 12, 11, 
                                ifelse(subPlot == 26, 8, NA)),
         comments = NA,
         date_comment = NA,
         recorder = "Joachim Topper",
...
Skj_1_1_Agr_mer_2022_fix <- community_clean |> 
  ...
  mutate(year = 2022,
         ...
         moss = ifelse(subPlot == 10, 30, 
                       ifelse(subPlot == 12, 5, 
                              ifelse(subPlot == 16, 5, 
                                     ifelse(subPlot == 17, 20, 
                                            ifelse(subPlot == 19, 8, 
                                                   ifelse(subPlot == 20, 40, NA)))))),
         lichen = ifelse(subPlot == 12, 5, NA),
         litter = ifelse(subPlot == 10, 10, 
                         ifelse(subPlot == 12, 30, 
                                ifelse(subPlot == 16, 30, 
                                       ifelse(subPlot == 17, 5, 
                                              ifelse(subPlot == 19, 40, 
                                                     ifelse(subPlot == 20, 5, NA)))))),
         soil = NA,
         rock = NA,
         poo = NA,
         fungus = NA,
         bare = NA,
         logger = NA,
         vegetation_height_mm = ifelse(subPlot == 10, 35, 
                                       ifelse(subPlot == 12, 35, NA)),
         moss_depth_mm = ifelse(subPlot == 10, 15, 
                                ifelse(subPlot == 12, 14, NA)),
         comments = NA,
         date_comment = NA,
...
Skj_1_3_Agr_mer_2019_fix <- community_clean |> 
  ...
  mutate(year = 2019,
         ...
         moss = ifelse(subPlot == 1, 45, 
                       ifelse(subPlot == 8, 50, 
                              ifelse(subPlot == 26, 90, 
                                     ifelse(subPlot == 28, 80, 
                                            ifelse(subPlot == 31, 40, 
                                                   ifelse(subPlot == 32, 45, 
                                                          ifelse(subPlot == 33, 60, NA))))))),
         lichen = NA,
         litter = ifelse(subPlot == 1, 10, 
                         ifelse(subPlot == 8, 15, 
                                ifelse(subPlot == 26, 10, 
                                       ifelse(subPlot == 28, 2, 
                                              ifelse(subPlot == 31, 2, 
                                                     ifelse(subPlot == 32, 3, 
                                                            ifelse(subPlot == 33, 20, NA))))))),
         soil = NA,
         rock = NA,
         poo = NA,
         fungus = NA,
         bare = NA,
         logger = NA,
         vegetation_height_mm = ifelse(subPlot == 26, 33, NA),
         moss_depth_mm = ifelse(subPlot == 26, 24, NA),
         comments = NA,
         date_comment = NA,
         recorder = "Joachim Topper",
         writer = "Joachim Topper",
...
Skj_1_3_Agr_mer_2022_fix <- community_clean |> 
  ...
  mutate(year = 2022,
         ...
         moss = ifelse(subPlot == 10, 2, 
                       ifelse(subPlot == 24, 3, 
                              ifelse(subPlot == 26, 10, 80))),
         lichen = NA,
         litter = ifelse(subPlot == 10, 10, 
                         ifelse(subPlot == 24, 20, 
                                ifelse(subPlot == 26, 20, 80))),
         soil = NA,
         rock = NA,
         poo = NA,
         fungus = NA,
         bare = NA,
         logger = ifelse(subPlot == 24, 40, NA),
         vegetation_height_mm = ifelse(subPlot == 10, 80, 
                                       ifelse(subPlot == 24, 55, 
                                              ifelse(subPlot == 26, 60, NA))),
         moss_depth_mm = ifelse(subPlot == 10, 17, 
                                ifelse(subPlot == 24, 11, 
                                       ifelse(subPlot == 26, 17, NA))),
         comments = NA,
         date_comment = NA,
         recorder = "Camilla Zernichow",
         writer = "Camilla Zernichow",
...
Skj_1_5_Agr_mer_2019_fix <- community_clean |> 
  ...
  mutate(year = 2019,
         ...
         moss = ifelse(subPlot == 4, 20, 
                       ifelse(subPlot == 8, 25, 
                              ifelse(subPlot == 10, 20, 
                                     ifelse(subPlot == 15, 25, 
                                            ifelse(subPlot == 17, 35, 
                                                   ifelse(subPlot == 26, 45, 
                                                          ifelse(subPlot == 32, 35, 
                                                                 ifelse(subPlot == 33, 40, NA)))))))),
         lichen = NA,
         litter = ifelse(subPlot == 4, 5, 
                         ifelse(subPlot == 8, 15, 
                                ifelse(subPlot == 10, 5, 
                                       ifelse(subPlot == 15, 20, 
                                              ifelse(subPlot == 17, 10, 
                                                     ifelse(subPlot == 26, 5, 
                                                            ifelse(subPlot == 32, 10, 
                                                                   ifelse(subPlot == 33, 5, NA)))))))),
         soil = NA,
         rock = NA,
         poo = NA,
         fungus = NA,
         bare = ifelse(subPlot == 26, 12, NA),
         logger = ifelse(subPlot == 4, 30, 
                         ifelse(subPlot == 10, 55, NA)),
         vegetation_height_mm = ifelse(subPlot == 10, 28, 
                                       ifelse(subPlot == 26, 31, NA)),
         moss_depth_mm = ifelse(subPlot == 10, 15, 
...
Skj_5_1_Agr_mer_2019_fix <- community_clean |> 
  ...
  mutate(year = 2019,
         ...
         moss = ifelse(subPlot == 2, 5, 
                   ifelse(subPlot == 3, 5, 
                      ifelse(subPlot == 6, 1, 
                         ifelse(subPlot == 12, 2, 
                            ifelse(subPlot == 17, 2, 
                               ifelse(subPlot == 18, 10, 
                                  ifelse(subPlot == 19, 15, 
                                     ifelse(subPlot == 20, 2, 
                                        ifelse(subPlot == 21, 25, 
                                           ifelse(subPlot == 22, 15, 
                                              ifelse(subPlot == 26, 10, 
                                                 ifelse(subPlot == 31, 5, 
                                                    ifelse(subPlot == 32, 2, 
                                                       ifelse(subPlot == 33, 40, NA)))))))))))))),
         lichen = NA,
         litter = ifelse(subPlot == 2, 10, 
                     ifelse(subPlot == 3, 20, 
                        ifelse(subPlot == 6, 15, 
                           ifelse(subPlot == 12, 15, 
                              ifelse(subPlot == 17, 25, 
                                 ifelse(subPlot == 18, 15, 
                                    ifelse(subPlot == 19, 15, 
                                       ifelse(subPlot == 20, 10, 
                                          ifelse(subPlot == 21, 3, 
                                             ifelse(subPlot == 22, 10, 
                                                ifelse(subPlot == 26, 15, 
                                                   ifelse(subPlot == 31, 10, 
                                                      ifelse(subPlot == 32, 10, 
                                                         ifelse(subPlot == 33, 10, NA)))))))))))))),
         soil = ifelse(subPlot == 6, 25,
                       ifelse(subPlot == 12, 5,
                              ifelse(subPlot == 17, 5,
                                     ifelse(subPlot == 18, 10, 
                                           ifelse(subPlot == 19, 2, 
         ...
         rock = NA,
         poo = NA,
         fungus = ifelse(subPlot == 6, 3,
                         ifelse(subPlot == 26, 8,
                                ifelse(subPlot == 31, 3,
                                       ifelse(subPlot == 32, 20, NA)))),
         bare = NA,
         logger = NA,
         vegetation_height_mm = ifelse(subPlot == 12, 18,
                                       ifelse(subPlot == 26, 16, NA)),
         moss_depth_mm = ifelse(subPlot == 12, 10,
                                ifelse(subPlot == 26, 16, NA)),
         comments = NA,
         date_comment = NA,
         recorder = "Joachim Topper",
         writer = "Joachim Topper & Inge Althuizen",
         vegetation_cover = 60)
  ...
  mutate(year = 2022,
         ...
         moss = ifelse(subPlot == 10, 3,
                       ifelse(subPlot == 17, 15,
                              ifelse(subPlot == 18, 5,
                                     ifelse(subPlot == 19, 25,
                                            ifelse(subPlot == 20, 20,
                                                   ifelse(subPlot == 26, 30, NA)))))),
         lichen = NA,
         litter = ifelse(subPlot == 10, 15,
                         ifelse(subPlot == 17, 10,
                                ifelse(subPlot == 18, 10,
                                       ifelse(subPlot == 19, 5,
                                              ifelse(subPlot == 20, 15,
         ...
         bare = NA,
         logger = NA,
         vegetation_height_mm = ifelse(subPlot == 10, 65,
                                       ifelse(subPlot == 26, 35, NA)),
         moss_depth_mm = ifelse(subPlot == 10, 16,
                                ifelse(subPlot == 26, 21, NA)),
         comments = NA,
         date_comment = NA,
         recorder = "Joachim Topper",
         writer = "Joachim Topper",
...
Skj_5_2_Agr_mer_2019_fix <- community_clean |> 
  ...
  mutate(year = 2019,
         ...
         moss = ifelse(subPlot == 19, 7,
                       ifelse(subPlot == 26, 15,
                              ifelse(subPlot == 33, 8, NA))),
         lichen = NA,
         litter = ifelse(subPlot == 19, 15,
                         ifelse(subPlot == 26, 10,
                                ifelse(subPlot == 33, 15, NA))),
         soil = NA,
         rock = NA,
         poo = NA,
         fungus = NA,
...
Skj_5_2_Agr_mer_2022_fix <- community_clean |> 
  ...
  mutate(year = 2022,
         ...
         moss = ifelse(subPlot == 17, 5,
                       ifelse(subPlot == 18, 15,
                              ifelse(subPlot == 19, 15,
                                     ifelse(subPlot == 24, 30,
                                            ifelse(subPlot == 26, 5, NA))))),
         lichen = NA,
         litter = ifelse(subPlot == 17, 10,
                         ifelse(subPlot == 18, 20,
                                ifelse(subPlot == 19, 15,
                                       ifelse(subPlot == 24, 10,
                                              ifelse(subPlot == 26, 12, NA))))),
         soil = ifelse(subPlot == 17, 10, NA),
         rock = NA,
         poo = NA,
         fungus = NA,
         bare = NA,
         logger = ifelse(subPlot == 17, 18, NA),
         vegetation_height_mm = ifelse(subPlot == 24, 38,
                                       ifelse(subPlot == 26, 32, NA)),
         moss_depth_mm = ifelse(subPlot == 24, 24,
                                ifelse(subPlot == 26, 9, NA)),
         comments = NA,
         date_comment = NA,
         recorder = "Joachim Topper",
         writer = "Joachim Topper",
...
Skj_5_3_Agr_mer_2019_fix <- community_clean |> 
  ...
  mutate(year = 2019,
         ...
         moss = ifelse(subPlot == 12, 5,
                       ifelse(subPlot == 14, 5,
                              ifelse(subPlot == 17, 2,
                                     ifelse(subPlot == 19, 10,
                                            ifelse(subPlot == 20, 10,
                                                   ifelse(subPlot == 24, 2,
                                                          ifelse(subPlot == 26, 15,
                                                                 ifelse(subPlot == 28, 1,
                                                                        ifelse(subPlot == 35, 1, NA))))))))),
         lichen = NA,
         litter = ifelse(subPlot == 12, 5,
                         ifelse(subPlot == 14, 10,
                                ifelse(subPlot == 17, 20,
                                       ifelse(subPlot == 19, 5,
                                              ifelse(subPlot == 20, 15,
                                                     ifelse(subPlot == 24, 30,
                                                            ifelse(subPlot == 26, 10,
                                                                   ifelse(subPlot == 28, 3,
                                                                          ifelse(subPlot == 35, 5, NA))))))))),
         soil = ifelse(subPlot == 12, 20,
                       ifelse(subPlot == 14, 10,
                              ifelse(subPlot == 19, 15,
                                     ifelse(subPlot == 20, 20,
                                            ifelse(subPlot == 24, 15,
                                                   ifelse(subPlot == 26, 40,
                                                          ifelse(subPlot == 28, 55,
                                                                 ifelse(subPlot == 35, 20, NA)))))))),
         rock = NA,
         poo = NA,
         fungus = NA,
         bare = NA,
         logger = ifelse(subPlot == 17, 40, NA),
         vegetation_height_mm = ifelse(subPlot == 12, 29,
                                       ifelse(subPlot == 24, 24,
                                              ifelse(subPlot == 26, 18, NA))),
         moss_depth_mm = ifelse(subPlot == 12, 17,
                                ifelse(subPlot == 24, 7,
                                       ifelse(subPlot == 26, 18, 13))),
         comments = NA,
         date_comment = NA,
         recorder = "Joachim Topper",
         writer = "Joachim Topper",
...
Skj_5_3_Agr_mer_2022_fix <- community_clean |> 
  ...
  mutate(year = 2022,
         ...
         moss = ifelse(subPlot == 19, 20,
                       ifelse(subPlot == 20, 3,
                              ifelse(subPlot == 24, 12,
                                     ifelse(subPlot == 26, 25, NA)))),
         lichen = NA,
         litter = ifelse(subPlot == 19, 15,
                         ifelse(subPlot == 20, 20,
                                ifelse(subPlot == 24, 8,
         ...
         fungus = NA,
         bare = NA,
         logger = ifelse(subPlot == 24, 2, NA),
         vegetation_height_mm = ifelse(subPlot == 24, 30,
                                       ifelse(subPlot == 26, 30, NA)),
         moss_depth_mm = ifelse(subPlot == 24, 10,
                                ifelse(subPlot == 26, 12, NA)),
         comments = NA,
         date_comment = NA,
         recorder = "Joachim Topper",
         writer = "Joachim Topper & Camilla Zernichow",
         vegetation_cover = 70)
  ...
  mutate(year = 2019,
         ...
         moss = ifelse(subPlot == 3, 2,
                       ifelse(subPlot == 14, 35,
                              ifelse(subPlot == 15, 10,
                                     ifelse(subPlot == 18, 25,
                                            ifelse(subPlot == 35, 10, NA))))),
         lichen = NA,
         litter = ifelse(subPlot == 3, 3,
                         ifelse(subPlot == 14, 10,
                                ifelse(subPlot == 15, 10,
                                       ifelse(subPlot == 18, 5,
                                              ifelse(subPlot == 35, 5, NA))))),
         soil = ifelse(subPlot == 3, 4,
                       ifelse(subPlot == 18, 15,
                                            ifelse(subPlot == 35, 5, NA))),
         rock = NA,
         poo = NA,
         fungus = NA,
         bare = NA,
         logger = ifelse(subPlot == 3, 40,
                         ifelse(subPlot == 18, 10, NA)),
         vegetation_height_mm = NA,
         moss_depth_mm = NA,
         comments = NA,
         date_comment = NA,
         recorder = "Joachim Topper",
         writer = "Inge Althuizen",
         vegetation_cover = 50)
...
Skj_5_4_Agr_mer_2022_fix <- community_clean |> 
  ...
  mutate(year = 2022,
         ...
         moss = ifelse(subPlot == 24, 30,
                       ifelse(subPlot == 26, 10, NA)),
         lichen = NA,
         litter = ifelse(subPlot == 24, 15,
                         ifelse(subPlot == 26, 30, NA)),
         soil = NA,
         rock = ifelse(subPlot == 24, 10, NA),
         poo = NA,
         fungus = NA,
         bare = NA,
         logger = NA,
         vegetation_height_mm = ifelse(subPlot == 24, 40,
                                       ifelse(subPlot == 26, 30, NA)),
         moss_depth_mm = ifelse(subPlot == 24, 20,
                                ifelse(subPlot == 26, 10, NA)),
         comments = NA,
         date_comment = NA,
         recorder = "Joachim Topper",
                              ...
                              ifelse(subPlot == 5, 10,
                                     ifelse(subPlot == 14, 2,
                                            ifelse(subPlot == 18, 1,
                                                   ifelse(subPlot == 19, 1,
                                                          ifelse(subPlot == 30, 2,
                                                                 ifelse(subPlot == 34, 3, NA)))))))),
         lichen = ifelse(subPlot == 4, 4, NA),
         litter = ifelse(subPlot == 3, 10,
                         ifelse(subPlot == 4, 10,
                                ifelse(subPlot == 5, 40,
                                       ifelse(subPlot == 14, 5,
                                              ifelse(subPlot == 18, 30,
                                                     ifelse(subPlot == 19, 10,
                                                            ifelse(subPlot == 30, 10,
                                                                   ifelse(subPlot == 34, 12, NA)))))))),
         soil = ifelse(subPlot == 4, 10,
                       ifelse(subPlot == 5, 5,
                              ifelse(subPlot == 14, 10,
                                     ifelse(subPlot == 18, 15,
                                            ifelse(subPlot == 30, 5, NA))))),
         rock = NA,
         poo = NA,
         fungus = NA,
         bare = NA,
                                                                ...
                                                                ifelse(subPlot == 20, 2,
                                                                      ifelse(subPlot == 28, 4,
                                                                            ifelse(subPlot == 29, 3,
                                                                                  ifelse(subPlot == 30, 5,
                                                                                        ifelse(subPlot == 31, 3,
                                                                                              ifelse(subPlot == 35, 4, NA)))))))))))))),
         lichen = ifelse(subPlot == 7, 10, NA),
         litter = ifelse(subPlot == 4, 40,
                        ifelse(subPlot == 6, 15,
                              ifelse(subPlot == 7, 10,
                                    ifelse(subPlot == 8, 15,
                                          ifelse(subPlot == 14, 5,
                                                ifelse(subPlot == 17, 25,
                                                      ifelse(subPlot == 18, 20,
                                                            ifelse(subPlot == 19, 40,
                                                                  ifelse(subPlot == 20, 45,
                                                                        ifelse(subPlot == 28, 10,
                                                                              ifelse(subPlot == 29, 10,
                                                                                    ifelse(subPlot == 30, 3,
                                                                                          ifelse(subPlot == 31, 2,
                                                                                                ifelse(subPlot == 35, 8, NA)))))))))))))),
         soil = ifelse(subPlot == 6, 15,
                       ifelse(subPlot == 7, 10,
                              ifelse(subPlot == 8, 15,
                                     ifelse(subPlot == 14, 5,
                                            ifelse(subPlot == 18, 20,
                                                   ifelse(subPlot == 28, 10,
                                                          ifelse(subPlot == 30, 3,
                                                                 ifelse(subPlot == 31, 2, NA)))))))),
         rock = NA,
         poo = NA,
         fungus = ifelse(subPlot == 28, 10, NA),
         bare = NA,
         logger = NA,
         vegetation_height_mm = NA,
         moss_depth_mm = NA,
  ...
  mutate(year = 2022,
         ...
         moss = ifelse(subPlot == 16, 15,
                       ifelse(subPlot == 17, 10,
                              ifelse(subPlot == 18, 5,
                                     ifelse(subPlot == 19, 5,
                                            ifelse(subPlot == 20, 3, NA))))),
         lichen = NA,
         litter = ifelse(subPlot == 16, 15,
                         ifelse(subPlot == 17, 25,
                                ifelse(subPlot == 18, 25,
                                       ifelse(subPlot == 19, 30,
                                              ifelse(subPlot == 20, 20, NA))))),
         soil = NA,
         rock = NA,
         poo = NA,
         fungus = NA,
